<div class="main-menu menu-fixed menu-dark menu-accordion menu-bordered menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="index.html"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">Dashboard</span><span class="badge badge badge-info badge-pill float-right mr-2">3</span></a></li>
            ...
            <li class=" nav-item"><a href="{{ route('etudiant') }}"><i class="la la-shopping-cart"></i><span class="menu-title" data-i18n="">Etudiants</span></a>
            </li>
